...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { comment: @time_entry.comment, date: @time_entry.date, name: @time_entry.name, tag: @time_entry.tag, time: @time_entry.time, time_dec: @time_entry.time_dec }
    end
  ...
  test "should update time_entry" do
    patch :update, id: @time_entry, time_entry: { comment: @time_entry.comment, date: @time_entry.date, name: @time_entry.name, tag: @time_entry.tag, time: @time_entry.time, time_dec: @time_entry.time_dec }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
